...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Carry existing role_user assignments over to Spatie's morph pivot before dropping the old table.
        DB::table('role_user')->select('user_id', 'role_id')->orderBy('user_id')->get()->each(function ($assignment) use ($tableNames, $columnNames, $pivotRole) {
            DB::table($tableNames['model_has_roles'])->insert([
                $pivotRole => $assignment->role_id,
                'model_type' => User::class,
                $columnNames['model_morph_key'] => $assignment->user_id,
            ]);
        });
